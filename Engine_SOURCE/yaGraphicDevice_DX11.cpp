...
namespace ya::graphics
{
	...
	void GraphicDevice_DX11::Clear()
	{
		...
		mContext->ClearRenderTargetView(mRenderTargetView.Get(), backgroundColor); ///RenderTargetView의 화면을 지워줌
	...
	void GraphicDevice_DX11::AdjustViewPorts()
	{
		...
		BindViewports(&mViewport);
		mContext->OMSetRenderTargets(1, mRenderTargetView.GetAddressOf(), mDepthStencilView.Get()); ///Output Merger
	}
